...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
            <a class="navbar-brand" href="index.php">SPB</a>
    ...
    <section>
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-md-5">
                    <img src="img/a9.png" alt="" class="img-fluid">
                </div>
                <div class="col-md mt-5">
                    <h3 class="mt-5">SPB (Sistem Pendaftaran Beasiswa) </h3>
                    <p class="text-justify">
                        SPB (Sistem Pendaftaran Beasiswa) adalah portal online khusus pendaftaran beasiswa yang berfungsi untuk melakukan pendataan dan pendaftaran beasiswa secara online yang dapat dilakukan dimanapun, kapanpun, dan fleksibel yang dapat mendukung dan memberi kesempatan pada mahasiswa universitas XYZ untuk mendapatkan hak pendidikan secara merata. <br>
                        Ayo bergabung dan daftarkan diri anda untuk memperoleh beasiswa-beasiswa unggulan.
                    </p>
    ...
    <div class="container">
        ...
        <form action="submit.php" method="post" enctype="multipart/form-data" class="mb-5">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="tel" class="form-control" id="hp" name="hp" pattern="[0-9]+" require>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#nama').on('input', function() {
                ...
                $.ajax({
                    ...
                    // Ketika ajax request sukses, script akan mengambil nilai ipk yang diterima dari server 
                    // dan memasukkan nilai tersebut ke dalam elemen dengan id 'ipk'. 
