        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <!-- akan ditampilkan data dalam bentuk tabel dengan menggunakan tag <tr> untuk setiap baris data, 
                    & tag <td> untuk setiap kolom data yang diambil dari variabel $row sesuai dengan nama kolom di tabel database. 
